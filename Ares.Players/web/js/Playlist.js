        ...
        handlers: {
            ...
            MusicRepeatInfo: function (msg, e) {
                ...
                if (msg.Repeat) {
                    ...
                    repeatButton.onmouseup = function () { switchImg(this, "/web/image/repeat_on.png"); }
                    repeatButton.src = "/web/image/repeat_on.png";
                }
                else {
                    repeatButton.class = "repeatButtonUnchecked";
                    repeatButton.setAttribute("alt", "Repeat (off)");
                    repeatButton.onclick = function () { repeatOn(); }
                    repeatButton.onmouseup = function () { switchImg(this, "/web/image/repeat_off.png"); }
                    repeatButton.src = "/web/image/repeat_off.png";
                }
            },
